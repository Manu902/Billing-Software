 ...
 * @author hp
 */
public class Change_P_E_Frame extends javax.swing.JFrame {

    /**
     * Creates new form ChangePassEmpFrame
     */
    private static EmpInformation info;
    
    public Change_P_E_Frame(EmpInformation info) {
        initComponents();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jPasswordField3, javax.swing.GroupLayout.PREFERRED_SIZE, 320, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       char[] confirm_P = jPasswordField3.getPassword();
       String confirm_P1 = new String(confirm_P);
       
       try
           (
               Connection con = Database_C.getConnection();
               PreparedStatement stm = con.prepareStatement("select *from registeremp where emailId = '"+email+"' and password = '"+oldPass1+"'");
               ResultSet rs = stm.executeQuery();
           )
       {
           if(rs.next())
           {
               if(newPass1.equals(confirm_P1))
               {
                   Validation val = new Validation();
                   if(!val.passwordValidation(newPass1))
                   {
                       JOptionPane.showMessageDialog(rootPane, "Password is not valid, special character not allowed");
                   }
                   else
                   {
                        try
                            (
                                Connection con1 = Database_C.getConnection();
                                PreparedStatement st = con1.prepareStatement("update registeremp set password = '"+confirm_P1+"' where emailId = '"+email+"'");
                            )
                        {
                            ...
                            if(i>0)
                            {
                                ...
                                JOptionPane.showMessageDialog(rootPane, "Did not change password due to some error", "Error", JOptionPane.ERROR_MESSAGE);
                        }
               ...
               JOptionPane.showMessageDialog(rootPane, "Old password incorrect...??", "Error", JOptionPane.ERROR_MESSAGE);
       }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Change_P_E_Frame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
