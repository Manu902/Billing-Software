...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBackground(new java.awt.Color(74, 18, 244));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
            (
              ...
              PreparedStatement stm = con.prepareStatement("select *from registeremp where emailId = '"+email+"' and password = '"+pass1+"'");
            ...
            )
        {
            if(rs.next())
            {
                ...
                {
                    Model.EmpInformation info = new Model.EmpInformation();
                    info.setName(rs.getString("name"));
                    info.setEmail(rs.getString("emailId"));
                    info.setGender(rs.getString("gender"));
                    info.setPhone(rs.getString("phone"));
                    
                    EmpProfile emp = new EmpProfile(info);
                    emp.setVisible(true);
                    setVisible(false);
                }
            }
            ...
            {
                JOptionPane.showMessageDialog(rootPane, "Email and password did not match", "Error", JOptionPane.ERROR_MESSAGE);
                jTextField1.setText("");
