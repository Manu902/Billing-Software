            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(38, 38, 38)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jPasswordField3, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
            (
               ...
               PreparedStatement stm = con.prepareStatement("select *from registeremp where emailId = 'admin@gmail.com' and password = '"+oldPass1+"'");
                ...
                if(newPass1.equals(confirmPass1))
                {
                    ...
                    else
                    {
                        ...
                        (
                            ...
                            PreparedStatement st = con1.prepareStatement("update registeremp set password = '"+newPass1+"' where emailId = 'admin@gmail.com'");
                        )
                        {
                    ...
                    JOptionPane.showMessageDialog(rootPane, "New password is not matched");
            }
            else
